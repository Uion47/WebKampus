export default function Contact() {
  return (
    <div className="contact-page py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8">Hubungi Kami</h1>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          Kami siap membantu Anda dengan informasi tentang universitas, program studi,
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Jl. Cokro Aminoto No. 123<br />Pinrang, Sulawesi Selatan 91200<br />Indonesia</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">(0421) 123456</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@ucap.ac.id</p>
                  <p className="text-gray-600">admissions@ucap.ac.id</p>
                </div>
              </div>
        ...
        {/* Map Placeholder */}
        <div className="mt-12">
          <h2 className="text-2xl font-semibold mb-6 text-center">Lokasi Kampus</h2>
          <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
            <p className="text-gray-600">Peta lokasi kampus akan ditampilkan di sini</p>
          </div>
        </div>
      </div>
    </div>
